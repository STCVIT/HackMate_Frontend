...
function displayTeams(){
  firebase.auth().onAuthStateChanged((user) =>
  {
    ...
    var init = async function () {
      try {
        var res = await axios(`${url}/DN_Team/all/${hack_id}?page=1`, {
          headers: {
    ...
    function displayTeams() {
      ...
      var init = async function () {
        try {
          var res = await axios(`${url}/DN_Team/all/${hack_id}?page=${page}`, {
            headers: {
              Authorization: "Bearer " + auth,
            },
          });
          ...
          for (let i = 0; i < hacks.final.length; i++) {
            if (hacks.final[i].participants.length == 1) {
              ...
              if (hacks.final[i].skills.length == 5) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots3'></span><span id = 'more3'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button></span></div></div><h4 id='myBtn3' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;'' onclick='myFunction3()'>View More</h4><div class='row' id='team-id-3' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 6) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots2'>...</span><span id = 'more2'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button></span></div></div><h4 id='myBtn2' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;'' onclick='myFunction2()'>View More</h4><div class='row' id='team-id-2' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 7) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots1'>...</span><span id = 'more1'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[6].skill + "</h6></button></span></div></div><h4 id='myBtn1' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;'' onclick='myFunction1()'>View More</h4><div class='row' id='team-id-1' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 8) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots'>...</span><span id = 'more'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[6].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[7].skill + "</h6></button></span></div></div><h4 id='myBtn' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction()'>View More</h4><div class='row' id='team-id' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
            }
            if (hacks.final[i].participants.length == 2) {
              ...
              if (hacks.final[i].skills.length == 5) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks.final[i].participants[1].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots3'>...</span><span id = 'more3'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button></span></div></div><h4 id='myBtn3' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction3()'>View More</h4><div class='row' id='team-id-3' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 6) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks.final[i].participants[1].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots2'>...</span><span id = 'more2'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button></span></div></div><h4 id='myBtn2' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction2()'>View More</h4><div class='row' id='team-id-2' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4' onclick='request()' value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 7) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks.final[i].participants[1].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots1'>...</span><span id = 'more1'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[6].skill + "</h6></button></span></div></div><h4 id='myBtn1' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction1()'>View More</h4><div class='row' id='team-id-1' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 8) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks.final[i].participants[1].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[1].skill + "</h6></button><span id='dots'>...</span><span id = 'more'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[6].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[7].skill + "</h6></button></span></div></div><h4 id='myBtn' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction()'>View More</h4><div class='row' id='team-id' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
            }
            if (hacks.final[i].participants.length == 3) {
              ...
              if (hacks.final[i].skills.length == 7) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks.final[i].participants[1].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[2].photo+"' class='Image3'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text18'>" + hacks.final[i].participants[2].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[1].skill + "</h6></button>See More<span id='dots1'>...</span><span id = 'more1'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[6].skill + "</h6></button></span></div></div><h4 id='myBtn1' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction1()'>View More</h4><div class='row' id='team-id-1' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
              if (hacks.final[i].skills.length == 8) {
                document.querySelector(".dam1").innerHTML +=
                  "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1' id='goods'><div class='card-body'><h3 class='text13' id='team1'>" + hacks.final[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks.final[i].participants.length +
                  "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks.final[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks.final[i].participants[1].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[2].photo+"' class='Image3'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text18'>" + hacks.final[i].participants[2].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[0].skill + "</h6></button><button class='button3'><h6 class='text20'>" + hacks.final[i].skills[1].skill + "</h6></button>See More<span id='dots'>...</span><span id = 'more'><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[2].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[3].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[4].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[5].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[6].skill + "</h6></button><button class='button3'><h6 class='text21'>" + hacks.final[i].skills[7].skill + "</h6></button></span></div></div><h4 id='myBtn' style='color:white; cursor:pointer; margin-left:165px; margin-top:15px; font-family: Nunito Sans; font-style: normal;letter-spacing: 0.04em; font-size: 18px;' onclick='myFunction()'>View More</h4><div class='row' id='team-id' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row' id='team-ids' style='display:none;'>"+hacks.final[i].team._id+"</div><div class='row'><input type='submit' class='button4'  onclick='request()'value='Request to Join'></div></div><div class='empty'></div></div></div>";
              }
            }
...
app.addEventListener('click', function () {
  ...
  if (n % 2 == 0) {
    ...
    displayTeams();
      var init = async function () {
        try {
          var res = await axios(`${url}/DN_Team/teamSkills/${hack_id}?page=1&skill=${occurence}`, {
            headers: {
              Authorization: "Bearer " + auth,
            },
          });
    ...
    function displayTeams() {
      ...
      var init = async function () {
        try {
          var res = await axios(`${url}/DN_Team/teamSkills/${hack_id}?page=${page}&skill=${occurence}`, {
            headers: {
              Authorization: "Bearer " + auth,
            },
          });
      ...
      for (let i = 0; i < hacks.length; i++) {
        if (hacks[i].participants.length == 1) {
          if (hacks[i].skills.length == 0) {
            document.querySelector(".dam1").innerHTML +=
              ...
              "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks[i].participants[0].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><h3 style='color:white; font-size:20px; font-family: Nunito Sans; margin-top: 17px;'>No Skills Required</h3></div></div><div class='row'><input type='submit' onclick='allow()' class='button4' value='Request to Join'></div></div><div class='empty'></div></div></div></div>";
          }
        ...
        if (hacks[i].participants.length == 2) {
          if (hacks[i].skills.length == 0) {
            document.querySelector(".dam1").innerHTML +=
              "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1'><div class='card-body'><h3 class='text13' id='team1'>" + hacks[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks[i].participants.length +
              "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks[i].participants[1].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><h3 style='color:white; font-size:20px; font-family: Nunito Sans; margin-top: 17px;'>No Skills Required</h3></div></div><div class='row'><input type='submit' class='button4' onclick='allow()' value='Request to Join'></div></div><div class='empty'></div></div></div></div>";
          }
          if (hacks[i].skills.length == 1) {
            document.querySelector(".dam1").innerHTML +=
              "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1'><div class='card-body'><h3 class='text13' id='team1'>" + hacks[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks[i].participants.length +
        ...
        if (hacks[i].participants.length == 3) {
          if (hacks[i].skills.length == 0) {
            document.querySelector(".dam1").innerHTML +=
              "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1'><div class='card-body'><h3 class='text13' id='team1'>" + hacks[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks[i].participants.length +
              "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks[i].participants[1].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[2].photo+"' class='Image3'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text18'>" + hacks[i].participants[2].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><h3 style='color:white; font-size:20px; font-family: Nunito Sans; margin-top: 17px;'>No Skills Required</h3></div></div><div class='row'><input type='submit' class='button4' onclick='allow()' value='Request to Join'></div></div><div class='empty'></div></div></div></div>";
          }
          if (hacks[i].skills.length == 1) {
            document.querySelector(".dam1").innerHTML +=
              "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1'><div class='card-body'><h3 class='text13' id='team1'>" + hacks[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks[i].participants.length +
        ...
        if (hacks[i].participants.length == 4) {
          if (hacks[i].skills.length == 0) {
            document.querySelector(".dam1").innerHTML +=
              "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1'><div class='card-body'><h3 class='text13' id='team1'>" + hacks[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks[i].participants.length +
              "</h2><h3 class='text15'>Team Members</h3></div><div class='col-lg-1 col-md-1 col-1'><div class='vertical'></div></div><div class='col-lg-8 col-md-8 col-8'><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[0].photo+"' class='Image1'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text16'>" + hacks[i].participants[0].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[1].photo+"' class='Image2'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text17'>" + hacks[i].participants[1].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[2].photo+"' class='Image3'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text18'>" + hacks[i].participants[2].name + "</h5></div></div><div class='row'><div class='col-lg-3 col-md-3 col-3'><img src='"+hacks.final[i].participants[3].photo+"' class='Image4'></div><div class='col-lg-7 col-md-7 col-7'><h5 class='text18'>" + hacks[i].participants[3].name + "</h5></div></div></div></div></div><div class='row'><div class='col-lg-4 col-md-4 col-4'><h3 class='text19'>Skills required :</h3></div><div class='col-lg-8 col-md-8 col-8'><h3 style='color:white; font-size:20px; font-family: Nunito Sans; margin-top: 17px;'>No Skills Required</h3></div></div><div class='row'><input type='submit' class='button4'  onclick='allow()' value='Request to Join'></div></div><div class='empty'></div></div></div></div>";
          }
          if (hacks[i].skills.length == 1) {
            document.querySelector(".dam1").innerHTML +=
              "<div class='col-lg-6 md-12 col-12'><div class='card_of_teams1'><div class='card-body'><h3 class='text13' id='team1'>" + hacks[i].team.name + "</h3><div class='row left'><div class='col-lg-3 col-md-3 col-3'><h2 class='text14'>" + hacks[i].participants.length +
      ...
      axios
        ...
        .catch((error) => {
          ...
          if (error.response.status == 403) {
            swal("WARNING!!", "You are already a part of this Hack so you can't send a request.", "warning");
          }
